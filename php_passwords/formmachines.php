...
<link rel="stylesheet" type="text/css" href="style_Open_Machines.css" />
...
<header class="header_Machines">  <div>  <h1>Machines</h1> </div> </header>
...
<button class="button_Open_Machines" style="vertical-align:middle" value="Open selected machines passwords" onclick='checkform()'> <span>Open Selected Machines </span></button>
